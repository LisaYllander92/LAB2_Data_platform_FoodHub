...
def process_recipe_data(input_path: str = "recipes_raw.json", output_path: str = "cleaning_recipe.json"):
    ...
    Pipeline steps:
    - Title: Normalize whitespace and convert to Title Case.
    - Cooking & Servings: Convert to integers, defaulting to 0 for missing values.
    - Image: Replace empty strings with None.
    - Ingredients: Strip whitespace and convert to lowercase.
    - Instructions: Fix punctuation spacing and capitalize sentences.
    - Allergies: Deduplicate, strip, and lowercase all entries.
